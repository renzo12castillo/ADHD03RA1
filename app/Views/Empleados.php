                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="agregarEmpleado" method="post">
                                    <label for="txt_codigo_empleado_add" class="form-label">Codigo de Empleado</label>
                                    <input type="number" name="txt_codigo_empleado_add" id="txt_codigo_empleado_add" class="form-control">
                    ...
                    <tbody>
                        <?php foreach ($datos as $empleado) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url('eliminar_empleado/') . $empleado['codigo_empleado']; ?>" class="btn btn-danger"><i class="bi bi-trash-fill"></i></a>
                                    <a href="<?= base_url('buscar_empleado/') . $empleado['codigo_empleado']; ?>" class="btn btn-info"><i class="bi bi-pencil-square"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                </table>

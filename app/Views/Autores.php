                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="agregarAutor" method="post">
                                    ...
                                    <label for="txt_nacionalidad_add" class="form-label">Nacionalidad</label>
                                    <input type="text" name="txt_nacionalidad_add" id="txt_nacionalidad_add" class="form-control">
                    ...
                    <tbody>
                        <?php foreach ($datos as $autor) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url('eliminar_autor/') . $autor['codigo_autor']; ?>" class="btn btn-danger"><i class="bi bi-trash-fill"></i></a>
                                    <a href="<?= base_url('buscar_autor/') . $autor['codigo_autor']; ?>" class="btn btn-info"><i class="bi bi-pencil-square"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                </table>

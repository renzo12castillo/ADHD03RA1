        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="d-flex justify-content-between align-items-center mt-2 mb-2">
                    <h1 class="mb-0">Modificar Empleado</h1>
                    <a href="<?= base_url('empleados'); ?>" class="btn btn-dark">
                        Volver
                    </a>
                </div>

                <form action="<?=base_url('actualizar_empleado')?>" method="post">
                    <label for="txt_codigo_empleado" class="form-label">Codigo de Empleado</label>
                    <input type="number" name="txt_codigo_empleado" id="txt_codigo_empleado" class="form-control" value="<?=$datos['codigo_empleado'];?>" readonly>

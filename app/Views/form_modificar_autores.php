        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="d-flex justify-content-between align-items-center mt-2 mb-2">
                    <h1 class="mb-0">Modificar Autor</h1>
                    <a href="<?= base_url('autores'); ?>" class="btn btn-dark">
                        Volver
                    </a>
                </div>

                <form action="<?=base_url('actualizar_autor')?>" method="post">
                    <label for="txt_codigo_autor" class="form-label">Codigo de Autor</label>
                    <input type="number" name="txt_codigo_autor" id="txt_codigo_autor" class="form-control" value="<?=$datos['codigo_autor'];?>" readonly>

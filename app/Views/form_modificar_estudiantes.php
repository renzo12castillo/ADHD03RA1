        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="d-flex justify-content-between align-items-center mt-2 mb-2">
                    <h1 class="mb-0">Modificar Estudiante</h1>
                    <a href="<?= base_url('estudiantes'); ?>" class="btn btn-dark">
                        Volver
                    </a>
                </div>
                ...
                <form action="<?=base_url('actualizar_estudiante')?>" method="post">
                    ...
                    <input type="number" name="txt_carne_alumno" id="txt_carne_alumno" class="form-control" value="<?=$datos['carne_alumno'];?>" readonly>
                    ...
                    <input type="date" name="txt_fecha_nacimiento" id="txt_fecha_nacimiento" class="form-control" value="<?=$datos['fechanacimiento'];?>">

                    <label for="txt_codigo_grado" class="form-label">Codigo de Grado</label>
